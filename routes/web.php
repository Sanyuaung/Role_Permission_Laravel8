...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/userroleedit/{id}', [UserController::class, "userroleedit"])->name("userroleedit");
    Route::post('/userroleupdate/{id}', [UserController::class, "userroleupdate"])->name("userroleupdate");
