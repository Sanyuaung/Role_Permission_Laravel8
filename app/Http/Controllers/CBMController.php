...
class CBMController extends Controller
{
    ...
    {
        $this->middleware('permission:Pssd01|Pssd02|Pssd04', 
            ['only' => ['pssd01home','pssd01print','pssd02home','fileinsert','pssd02input','pssd02print','pssd04home','pssd04print']]);
        $this->middleware('permission:Pssd01_DL|Pssd02_DL|Pssd04_DL', 
            ['only' => ['pssd01download','pssd02download','pssd04download']]);
    }
