...
class onecardController extends Controller
{
    ...
    {
        $this->middleware('permission:ATM|CO|CrAnnualFee|DbCardList|AcqOnUs|CrCardStatus', 
            ['only' => ['atmhome','atmprint','cohome','coprint','annualfeehome','AnnualFeePrint','cardhome',
            'cardprint','onushome','onusprint','credithome','creditlistprint']]);
        $this->middleware('permission:ATM_DL|CO_DL|CrAnnualFee_DL|DbCardList_DL|AcqOnUs_DL|CrCardStatus_DL|ExportMerchant', 
            ['only' => ['atmdownload','codownload','AnnualFeedownload','cardlistdownload','onusdownload','creditdownload','export']]);
    }
