...
class VisaDataController extends Controller
{
    ...
    {
        $this->middleware('permission:Visa|VisaShowAll',['only' => ['visa','insert','show']]);
        $this->middleware('permission:VisaShowAll|VisaEdit|Visa_DL',['only' => ['show','visaedit','visadownload']]);
        $this->middleware('permission:VisaEdit',['only' => ['visaedit','visaupdate']]);
        $this->middleware('permission:Visa_DL',['only' => ['visadownload']]);
        $this->middleware('permission:CCY',['only' => ['ccy','ccyinsert']]);
    }
